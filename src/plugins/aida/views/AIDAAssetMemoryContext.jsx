// src/plugins/aida/views/AIDAAssetMemoryContext.jsx
//
// Read-only MAIA context for an AIDA asset row. This intentionally lives inside
// the AIDA plugin so AIDA UI does not import OS app UI components.
// MAIA informs; it does not execute actions.
...
export default function AIDAAssetMemoryContext({ assetId, assetName, title = 'Prior MAIA decisions for this asset' }) {
  ...
  return (
    <div className="mt-3 border-t border-neutral-800 pt-3" data-testid="aida-asset-maia-context">
      <button
        type="button"
        onClick={toggle}
        aria-expanded={open}
        ...
        data-testid="aida-asset-maia-toggle"
      >
        ...
        <div className="mt-2 rounded-lg border border-neutral-800 bg-neutral-950 p-3">
          ...
          {isEmpty && !loading && !error && (
            <div className="text-xs text-neutral-500">
              No prior MAIA memory recorded for this asset yet.
            </div>
          )}
            ...
            <ul className="space-y-1">
              {nodes.map((node) => (
                <li
                  ...
                  data-testid="aida-asset-maia-node"
                >
