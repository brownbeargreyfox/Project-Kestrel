      ...
      <header className="border-b border-neutral-800 p-4">
        <div className="flex flex-wrap items-start justify-between gap-3">
          ...
          <div className="flex flex-wrap gap-2">
            ...
            <button
              type="button"
              onClick={() => launchApp('network-map')}
              className="inline-flex items-center gap-2 rounded-lg border border-sky-800 bg-sky-950/50 px-3 py-2 text-sm text-sky-200 hover:bg-sky-900/60"
              data-testid="network-open-map"
            >
              <Globe size={16} />
              Open Map
            </button>
