                  ...
                  >
                    ...
                    {aidaNotice.type === 'ok' && (
                      <button
                        ...
                        className="mt-1.5 inline-flex items-center gap-1.5 rounded border border-emerald-700 bg-emerald-950/60 px-2 py-1 text-[11px] text-emerald-100 hover:bg-emerald-900"
                        data-testid="network-open-aida"
                      >
                        Open AIDA Sentinel →
                      </button>
                    )}
